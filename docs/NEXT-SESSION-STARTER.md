...
Manual 全过：torch 2.11.0+cpu + torch_npu 2.11.0rc1 + CANN 8.5.1 overlay → vllm-ascend Fix B+ patch (2 commits 在 `zhshgmail/vllm-ascend/ascend-day0-torch211-20260423`) → V1.3 Qwen2-0.5B rollout **PASS**：
