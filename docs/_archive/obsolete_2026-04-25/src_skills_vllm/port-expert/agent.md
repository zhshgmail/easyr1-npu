...
6. `docs/_meta/design-subdocs/SKILLS_ARCH_TARGET.md` Day-0 reframing section
...
- `../vllm/port-expert/_legacy-upgrade/references/patterns/domains/vllm-rename-catalog.md` — for outcome B shims
