...
|---|---|---|---|---|---|---|---|---|
| **transformers (upgrade)** | 5.3.0.dev0 → 5.6.0 | [`src/skills/transformers/port-expert/_legacy-upgrade/`](../src/skills/transformers/port-expert/_legacy-upgrade/) | [`workspace/transformers/transformers-upgrade-trans-upg-e2e-20260422-2200/`](../../workspace/transformers/transformers-upgrade-trans-upg-e2e-20260422-2200/) | `ascend-upg-trans-upg-e2e-20260422-2200` on `zhshgmail/transformers` | ✅ PASS | ✅ PASS entropy_loss=1.310 in band [1.21, 1.34] | v2 image `easyr1-npu-trans56:trans-day0-wetrun-20260423-0109` | 2026-04-22 完成 |
| **transformers (Day-0 probe 5.6.0)** | 5.6.0 | [`src/skills/transformers/port-expert/`](../src/skills/transformers/port-expert/) | [`workspace/transformers/transformers-day0-trans-day0-wetrun-20260423-0109/`](../../workspace/transformers/transformers-day0-trans-day0-wetrun-20260423-0109/) | 同 upgrade branch | ✅ PASS | ✅ PASS | 同上 | Day-0 + upgrade merged artifact |
| **torch / torch_npu (Day-0)** | torch 2.11.0+cpu + torch_npu 2.11.0rc1 | [`src/skills/torch-npu/port-expert/`](../src/skills/torch-npu/port-expert/) | [`workspace/torch-npu/torch-day0-{analysis,manual,deploy}-20260423-*`](../../workspace/) | (Fix C commits in `ascend-day0-torch211-20260423` on `zhshgmail/vllm-ascend`) | ✅ PASS | ✅ PASS entropy_loss=1.275 **exact match** baseline | Fix C image `easyr1-npu-torch211-fixc:ascend-day0-torch211-20260423` | 需要 Fix C `vllm_ascend_C.so` rebuild 才过 V1.4 |
| **vllm-ascend (Day-0 for torch 2.11)** | patched 0.17.0rc2.dev109 | [`src/skills/vllm-ascend/port-expert/`](../src/skills/vllm-ascend/port-expert/) | [`workspace/vllm-ascend/vllm-ascend-day0-{analysis,deploy}-20260423-*`](../../workspace/) | `ascend-day0-torch211-20260423` (4 commits for torch 2.11 Fix B+/C) | ✅ PASS | ✅ PASS | 同 torch Fix C image | torch 2.11 上 V1.3+V1.4 都过 |
| **vllm (Day-0 probe 0.20.0)** | 0.20.0 | [`src/skills/vllm-ascend/port-expert/`](../src/skills/vllm-ascend/port-expert/) (原 `src/skills/vllm/` 于 2026-04-25 archived) | [`workspace/vllm/vllm-day0-vllm0200-20260423-1623/`](../../workspace/vllm/vllm-day0-vllm0200-20260423-1623/) | 同 `ascend-day0-torch211-20260423` (iter 1-18 新增 13+ commits) | ✅ bit-exact PASS (iter 18) | ⏳ V1.4 running (with VLLM_BATCH_INVARIANT=0) | iter 18 image `easyr1-npu-vllm0200:vllm-day0-vllm0200-20260423-1623-iter18` | **正在 wet-run**; PROGRESS.md 实时更新 |
| **EasyR1 (consumer port)** | main tip (dd71bbd) | [`src/skills/easyr1/port-expert/`](../src/skills/easyr1/port-expert/) | [`workspace/easyr1/easyr1-port-*`](../../workspace/) | `ascend-port` on `zhshgmail/EasyR1` (16 commits) | ✅ PASS | ✅ PASS | v1 image `easyr1-npu:ascend-port` | 最外层 consumer，不 Day-0 |

## 活跃 session（正在跑的，**非** auto-compact 可抹去）

| Session | Status | PROGRESS.md | 接手入口 |
|---|---|---|---|
| `vllm-day0-vllm0200-20260423-1623` | V1.3 PASS; V1.4 smoke running | [`workspace/.../PROGRESS.md`](../../workspace/vllm/vllm-day0-vllm0200-20260423-1623/PROGRESS.md) | 读 PROGRESS → 看 iter 18 最后段 |
