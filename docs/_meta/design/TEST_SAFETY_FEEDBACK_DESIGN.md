# 测试网 + 安全网 + 反馈环 — 设计文档（v2，post-codex-review）

> **Status**: v1 (2026-05-15 起草) → codex review 2026-05-15（[review verbatim](review/2026-05-15_codex_review_T30_design.md)）→ **v2 本文档**，应用 6 项 recommendation。
>
...
T22-T28 6 个 session 暴露了 **6 类结构性缺陷**（v2 新增第 5/6 类，来自 codex review）：
...
Job：**schema 层**校验 claim_manifest.yaml。
