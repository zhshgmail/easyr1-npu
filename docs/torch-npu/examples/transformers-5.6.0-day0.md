...
- `docs/_meta/design-subdocs/SKILLS_ARCH_TARGET.md` §"Day-0 Reframing" —— 这个 skill 存在的
  ...
  ship 的情况
- `src/skills/transformers/port-expert/README.md` —— skill 定义 + 当日
  realtime baseline
- `src/skills/transformers/port-expert/references/patterns/domains/api-drift-scan.md`
  —— probe 协议 + 本例观察到的 ALL_ATTENTION_FUNCTIONS 扩张细节
- `src/skills/transformers/port-expert/references/patterns/domains/overlay-image.md`
