# `docs/vllm-ascend/` — 上游 `github.com/vllm-project/vllm-ascend` 专属文档

本目录收纳 vllm-ascend 相关的所有 port-time 文档：port notes、blocker reports 的沉淀版、给维护者的 PR 材料索引、历史 changelog 与 drift 记录等。
