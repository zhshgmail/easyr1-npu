...
- **V1.4 smoke rerun silently skips training, only val row in jsonl (stale global_step_N auto-resumed)** → EC-13
- **V1.3 smoke fails with `/data/nobody/...` path / HFValidationError (container $USER is 'nobody')** → EC-14
