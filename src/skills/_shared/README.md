...
`easyr1/port-expert/`, `transformers/port-expert/_legacy-upgrade/`) includes its own
...
1. Copy `src/skills/_shared/templates/state_machine_skeleton.yaml` →
   `src/skills/<expert-name>/state_machine.yaml`, fill in phases + invariants.
2. Copy `src/skills/_shared/templates/agent_brief_skeleton.md` →
   `src/skills/<expert-name>/agent.md`, fill in Phase A/B/C/D specifics.
