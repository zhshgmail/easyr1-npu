...
1. `src/skills/easyr1/port-expert/references/ALWAYS_LOADED_RULES.md` — OL-01..OL-10
2. `src/skills/easyr1/port-expert/references/KB_INDEX.md` — route to pattern/EC files
...
| Var | Meaning | Default |
|---|---|---|
| `EASYR1_EXPERT_ROOT` | abs path to `src/skills/easyr1-expert` | (required) |
...
2. `cd upstream/EasyR1 && git checkout $EASYR1_REF && git rev-parse HEAD`.
   Record the SHA.
3. Run `bash ../../repo/src/skills/easyr1/port-expert/scripts/code_path_sweep.sh
