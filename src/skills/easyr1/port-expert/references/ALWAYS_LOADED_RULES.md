...
```bash
bash src/skills/easyr1/port-expert/scripts/static_check.py --files <edited-files> --import-package verl
```
...
- ❌ `src/skills/easyr1/port-expert/**`（expert 本身不改）
- ❌ `docs/` / `knowledge/`（历史记录）
- ❌ 其他 host / 其他用户的目录
...
- KB：`src/skills/easyr1/port-expert/references/`
- Scripts：`src/skills/easyr1/port-expert/scripts/`
