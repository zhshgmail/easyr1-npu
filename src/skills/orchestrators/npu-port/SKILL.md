...
- `../../skills/dep-analysis/expert/` — step 1 expert
- `../../skills/transformers/port-expert/_legacy-upgrade/` — step 2 candidate
- `../../skills/easyr1/port-expert/` — step 3 consumer port
- `../../skills/_shared/` — universal OL rules + reference hooks/scripts
