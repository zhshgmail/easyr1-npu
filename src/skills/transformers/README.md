...
|---|---|---|
| [`port-expert/`](port-expert/) | Day-0 probe of a new transformers release before NPU integration catches up. | transformers NPU integration maintainers + downstream |
| [`port-expert/_legacy-upgrade/`](port-expert/_legacy-upgrade/) | Shim-adapt transformers to a new release on a known-good NPU image. | EasyR1 / RL framework porters |
